			...
			<div className="h-[103px] w-full bg-main flex items-center justify-center">
				<div className="w-main flex items-center justify-between">
					...
					<div className="flex-1 flex items-center">
						<input
							className="p-4 pr-0 rounded-l-full  w-full bg-[#F04646] outline-none text-gray-100 placeholder:text-sm placeholder-gray-200 placeholder:italic placeholder:opacity-50"
			...
			<div className="h-[407px] w-full bg-gray-900 flex items-center justify-center text-white text-[13px]">
				<div className="w-main flex ">
					<div className="flex-2 flex flex-col gap-2">
						...
						<span>
							<span> Address: </span>
							<span className="opacity-70">Quận Phú Nhuận, TPHCM</span>
						</span>
						<span>
							<span>Phone: </span>
							<span className="opacity-70">(+84) 089 933 1703</span>
						</span>
						<span>
							<span>Mail: </span>
							<span className="opacity-70">nguyenduyhai308@gmail.com</span>
						</span>
					</div>
